...
describe("login", () => {
  ...
  test("deve cair em erro caso o e-mail não seja uma string", async () => {
    try {
      const input: LoginInputDTO = {
        email: null,
        password: "bananinha",
  ...
  test("Deve cair em error se o e-mail não exista", async () => {
    try {
      const input: LoginInputDTO = {
        email: "aaa@email.com",
        password: "bananinha",
  ...
  test("Deve cair em erro caso o password esteja incorreto", async () => {
    try {
      const input: LoginInputDTO = {
        email: "admin@email.com",
        password: "seila123",
